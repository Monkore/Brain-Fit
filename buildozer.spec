...
# (str) Package name
package.name = brainfit

# (str) Package domain (needed for android/ios packaging)
package.domain = org.brainfitai

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,db,wav,mp3,ttf,json
...
requirements = python3,kivy==2.3.0,kivymd,sqlite3,numpy,pandas,scikit-learn,opencv-python,mediapipe,vosk,pyjnius
...
# This can be useful to avoid internet access or save time
